...
class InspectionAdmin(admin.ModelAdmin):
    list_display = ('video', 'mode', 'status', 'overall_score', 'created_at')
    list_filter = ('mode', 'status', 'video__store__brand', 'created_at')
    search_fields = ('video__title', 'video__store__name')
    readonly_fields = ('ai_analysis', 'created_at', 'updated_at')
    list_select_related = ('video', 'video__store')
...
class FindingAdmin(admin.ModelAdmin):
    ...
    search_fields = ('title', 'description', 'inspection__video__title')
